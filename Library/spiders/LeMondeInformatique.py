...
class LeMondeInformatique(scrapy.Spider):
    website = WebsiteRepository.get_by_libelle("LeMondeInformatique")
    ...
    def parse(self, response):
        ...
        for div in response.css("div.row"):
           
            title = div.css("a.title::text").get()
